...
| **Gates**        | `pnpm verify:release-candidate` ✅ (migrations · official-Supabase record · format · lint · typecheck · **413 unit** · **56 web-server** · **pg** · e2e compile · no-external-IO · build · secret-scan) · **RLS harness 349/349** ✅ + **pg-phase8 9/9** + **pg-phase9 6/6** + **pg-demo-seed 14/14** ✅ · migrations 0001–0030 ✅                                                                                                                |
